...
for (const { label, regionName, ctaText, open } of [
  ...
  { label: "next", regionName: "Next", ctaText: /see your next episode/i, open: (p) => p.next.open() },
  { label: "trending", regionName: "Trending", ctaText: /save trending shows/i, open: (p) => p.trending.open() },
  { label: "similar", regionName: "Similar", ctaText: /find titles similar/i, open: (p) => p.similar.open() },
  { label: "mood", regionName: "Mood", ctaText: /get picks for any mood/i, open: (p) => p.mood.open() },
]) {
