...
export function setupGrokChat(page, responseText, expectedKey, expectedRatings) {
  return page.route("**/api.x.ai/**", async (route) => {
    ...
    expect(body.messages[0].content).toMatch(/Do not suggest any title in the user.s Library/)
